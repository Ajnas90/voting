...
SECRET_KEY = 'django-insecure-4n&%@65$&gvm_3r08a*seqrrp&ay6b-p%ejshux#l*cbww(@-&'
...
INSTALLED_APPS = [
    ...
    'cvote.apps.CvoteConfig',
    'votingstatus.apps.VotingstatusConfig',
    'withdrawstatus.apps.WithdrawstatusConfig',
